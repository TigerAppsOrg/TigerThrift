...
from sendemail import (
    ...
    send_buyer_reservation_reminder,
    send_seller_reservation_reminder,
    send_buyer_expiration_notification,
    send_seller_expiration_notification,
)
        ...
        with connect(DATABASE_URL, sslmode="require") as connection:
            with closing(connection.cursor()) as cursor:
                ...
                for item in list_of_items:
                    ...
                    dt = now.strftime(f)
                    days_between(
                        dt, item["reserved_time"], seller, buyer, item["prodname"]
                    )
